<div class="col-sm-4 col-md-3 photo item">
	<div class="panel panel-default">
		<div class="panel-body">
			<img src="{{URL::asset($photo->src)}}" class="img-responsive">
			<p class="photo-name"><h3>{{$photo->name}}</h3></p>
			@if($photo->intro=="")
			<p class="photo-intro"> <h3> no introduction..</h3></p>
			@else
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form action="{{ route('photo.destroy', $photo->id) }}" method="post" style="float:right;position:relative;top:-35px">
            {{ csrf_field() }}
            {{ method_field('DELETE') }}
